...
--
ALTER TABLE `banhang`
  ADD PRIMARY KEY (`HDID`,`MHID`,`HOADON_HDID`,`MATHANG_MHID`),
...
--
ALTER TABLE `hoadon`
  ADD PRIMARY KEY (`HDID`,`KHACHHANG_KHID`,`NHANVIEN_NVID`,`NHANVIEN_PHONGBAN_PBID`),
...
--
ALTER TABLE `banhang`
  ADD CONSTRAINT `fk_BANHANG_HOADON` FOREIGN KEY (`HOADON_HDID`) REFERENCES `hoadon` (`HDID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
--
ALTER TABLE `hoadon`
  ADD CONSTRAINT `fk_HOADON_KHACHHANG1` FOREIGN KEY (`KHACHHANG_KHID`) REFERENCES `khachhang` (`KHID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
